...
public class MentionsFragment extends BlankFragment {
    ...
    //static MentionsFragment fragment;
    public static MentionsFragment getInstance(BaseActivity activity) {
        //if(fragment == null) {
    ...
    public void populateTimelineRefresh(){
        ...
        twitterClient.getMentionTimeline(new JsonHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONArray response) {
                ...
                tweets.clear();
                tweets.addAll(tweetList);
                if(MentionsFragment.this.getUserVisibleHint())
                    tweetAdapter.notifyDataSetChanged();
